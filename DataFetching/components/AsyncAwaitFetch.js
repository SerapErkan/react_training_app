...
(async ()=>{
    ...
    const data3 = await (await fetch("https://jsonplaceholder.typicode.com/users/3")).json();
    const data4 = await (await fetch("https://jsonplaceholder.typicode.com/users/4")).json();
